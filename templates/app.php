...
<body class="bg-gray-50 h-screen overflow-hidden text-slate-800 font-sans">
    ...
    <div id="app" v-cloak class="flex h-full w-full flex-col md:flex-row">
        ...
        <!-- RIGHT SIDE: CART (Responsive Drawer on Mobile) -->
        <div :class="{'translate-y-0': showMobileCart, 'translate-y-full md:translate-y-0': !showMobileCart}" 
            ...
            <!-- Mobile Cart Handle -->
            <div class="md:hidden flex justify-center pt-2 pb-1" @click="showMobileCart = false">
                <div class="w-10 h-1 bg-gray-300 rounded-full"></div>
            </div>

            <div class="px-4 md:px-6 py-3 md:py-5 border-b flex justify-between items-center bg-white shrink-0">
                <h2 class="font-bold text-lg flex items-center gap-2">
                    <span class="bg-blue-100 text-blue-600 p-1 rounded"><i class="ri-shopping-cart-2-fill"></i></span> Keranjang
                </h2>
            ...
            <div class="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-white">
                <div v-if="cart.length===0" class="flex flex-col items-center justify-center h-full text-slate-300">
                    <i class="ri-shopping-basket-line text-6xl opacity-20"></i>
        ...
        <!-- THERMAL RECEIPT (58mm/80mm Compatible) -->
